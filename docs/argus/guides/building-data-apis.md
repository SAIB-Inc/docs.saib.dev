...
![Building Data APIs](/img/docs/argus/guides/data-api-banner.webp)
...
- **Minimal API Endpoint (within `apiV1` group)**:
  ...
  2. Or, use the [Chrysalis](../../chrysalis/cbor/overview.md) library (which Argus leverages for CBOR processing) to deserialize the `RawCbor` field from the `OutputBySlot` table.
     :::
