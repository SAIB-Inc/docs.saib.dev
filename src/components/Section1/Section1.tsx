...
export default function Section1(): ReactNode {
    ...
    return (
        <section style={{backgroundColor: theme.palette.background.default}} className={`relative grid place-content-center w-screen h-screen bg-cover ${colorMode === 'dark' ? "bg-[url(/img/background_dark.webp)]" : "bg-[url(/img/background_light.webp)]"}`}>
