...
export default function Section3(): ReactNode {
    return (
        <section className="bg-darkbg bg-lines h-[1088.02px] flex flex-col items-center bg-[url(/img/Section3/background.webp)] w-screen bg-cover">
            <div className="w-[1312px] flex flex-col justify-center items-center">

                <div className="text-center h-[64px] flex flex-row items-center mb-[178px] mt-[36px]">
                    <div>
                        <img alt="Buriza"
                            src="/img/Section3/buriza.webp" />
                    </div>
                    <div className="ml-[80px]">
                        <img
                            src="/img/Section3/arrow.webp" />
                    </div>
                    ...
                    <div>
                        <img
                            src="/img/Section3/arrow.webp" className="scale-x-[-1] mr-[80px]" />
                    </div>
                    <div>
                        <img
                ...
                <div>
                    <div className="mb-[64.94px] flex flex-row">
                        <div className="w-[755px] h-[108px] flex flex-row items-center justify-center">
                            <h1><span className="text-[#C2B8FF] text-[56px] font-semibold leading-[53.76px]">Argus</span><span className="text-white text-[56px] font-semibold leading-[53.76px]"> - The .NET Cardano Indexing Framework</span></h1>
                        </div>
                    ...
                    <div>
                        <img src='/img/Section3/code.webp' ></img>
                    </div>
                </div>
            </div>
        </section>
