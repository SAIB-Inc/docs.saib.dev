...
import CodePortrait from "@site/static/img/Section9/code_portrait";
...
export default function Section9(): ReactNode {
    ...
    return (
        <section className="w-screen md:py-20">
            <div className="container !mx-auto !p-11 md:p-0 ">
                <div className="w-full md:mb-5 lg:mb-0">
                    <Paper
                        className="sm:h-[650px] md:h-[510px] lg:h-[619.7px]"
                        sx={{
                    ...
                    >
                        ...
                        <div>
                            <Futura className="absolute !hidden md:!block md:!text-[200px] md:top-[270px] md:right-[56px] lg:!text-[225px] lg:top-[170.16px] lg:right-[10px] xl:text-[300px] xl:top-[100px] xl:right-[30px] 2xl:!text-[321px] 2xl:top-[100px] 2xl:right-[30px]" />
                        </div>
                        <div className="w-full p-6 flex flex-col md:absolute md:left-8 md:top-8 ">
                            <h1 className="!text-2xl sm:text-[32px] md:!mb-[-12px] lg:!mb-10lg:!text-[40px] lg:leading-[41.6px] xl:!mb-5 ">
                            ...
                            <CodePortrait className="self-center !text-[275px] sm:!text-[500px] md:!hidden" />
                        ...
                        <div>
                            ...
                            <div style={{ borderColor: theme.palette.background.default, transform: 'rotate(270deg)' }} className="hidden absolute top-[46px] right-[-8px] border-r-8 border-b-8 w-14 aspect-square rounded-br-3xl lg:block lg:border-r-7 lg:border-b-7 lg:w-13"></div>
                        </div>
                    </Paper>
                </div>
                ...
                <div className="relative flex flex-col-reverse gap-6 md:flex-col lg:flex-row lg:gap-5">
                    ...
                    <div className="flex flex-col justify-between gap-6 md:flex-row md:gap-4 md:pt-5 lg:w-[calc(100%-350px)] lg:gap-5 xl:w-[calc(100%-400px)] 2xl:w-[calc(100%-496px)] ">
                        <Paper
